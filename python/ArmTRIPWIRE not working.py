...
def RCtime (RCpin): ## Setup LDR detection
        ...
        time.sleep(0.05) ## this is how fast it captures light
...
while True:
    ...
    ## Alertlevel = RCtime(18)*5  ##This is an adaptive calibtration still in testing
    print "light Level @ ",
    print Lightlevel ## this is the current light level with the laser on
    #print "0"; 
